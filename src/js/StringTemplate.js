...
var PROTO = 'prototype', HAS = Object[PROTO].hasOwnProperty, GUID = 0;

function guid()
{
    return String(new Date().getTime()) + '--' + String(++GUID);
}
    ...
    ,render: function(args) {
        ...
        for (i=0; i<l; ++i)
        {
            ...
            else
            {
                ...
                out += HAS.call(args, s) ? String(args[s]) : '';
            }
        }
        return out;
    }
